...
exports.IncreaseCounter = exports.IncreaseCounterRequest = exports.CreateCounter = exports.CreateCounterRequest = exports.CounterApplicationContext = exports.CounterValueChanged = exports.CounterCreated = exports.Counter = exports.CounterId = void 0;
const domain_1 = require("../../domain");
const application_1 = require("../../application");
const message_1 = require("../../message");
const in_memory_database_concerns_1 = __importDefault(require("./in-memory-database-concerns"));
...
class CounterApplicationContext {
    static dbConcerns = new in_memory_database_concerns_1.default();
    static unitOfWork = this.dbConcerns.asUnitOfWork();
    static outboxEventPublisher = this.dbConcerns.createOutboxEventPublisher();
    static publishedEventTracker = this.dbConcerns.createPublishedEventTracker();
    static consumedEventTracker = this.dbConcerns.createConsumedMessageTracker();
    static counterRepository = this.dbConcerns.createRepository({
        namespace: "counter",
...
exports.CounterApplicationContext = CounterApplicationContext;
