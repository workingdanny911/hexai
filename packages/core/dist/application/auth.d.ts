...
export type FactorOf<A extends Authenticator> = A extends Authenticator<infer Factor> ? Factor : never;
export type SecurityContextOf<A extends Authenticator> = A extends Authenticator<any, infer SecurityContext> ? SecurityContext : never;
