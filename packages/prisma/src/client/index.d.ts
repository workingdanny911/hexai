  ...
  */
  ...
  export interface EventDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * const eventWithPositionOnly = await prisma.event.findMany({ select: { position: true } })
     * 
    **/
  ...
  interface EventFieldRefs {
    readonly position: FieldRef<"Event", 'BigInt'>
  ...
  export type EventWhereInput = {
    ...
    position?: BigIntFilter<"Event"> | bigint | number
  ...
  export type EventScalarWhereWithAggregatesInput = {
    ...
    position?: BigIntWithAggregatesFilter<"Event"> | bigint | number
